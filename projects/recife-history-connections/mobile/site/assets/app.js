...
(function () {
  ...
  var EN = {
    ...
    "sobre-metodo-h": "Method",
    "sobre-metodo-1": "The method combines reading and analysis of sources, identification of the associated places on a map, and building a relationship matrix between the records. This matrix organizes the connections using four main criteria: direct interaction, territorial proximity, historical period, and consequence of the events.",
    "sobre-metodo-2": "After this stage, the data goes through cleaning, normalization, and quality validation, with continuous corrections whenever new inconsistencies, gaps, or opportunities for improvement are identified.",
