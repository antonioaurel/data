...
def render_about():
    ...
    body = (
        ...
        "<hr class='divider'>\n"
        "<h2 class='section-h' style='margin:12px 0 6px' data-i18n='sobre-metodo-h'>Método</h2>\n"
        "<p class='about-p' data-i18n='sobre-metodo-1'>O método combina leitura e análise de fontes, "
        "identificação dos locais associados em mapa e construção de uma matriz de relação entre os "
        "registros. Essa matriz organiza as conexões a partir de quatro critérios principais: "
        "interação direta, proximidade territorial, período histórico e consequência dos eventos.</p>\n"
        "<p class='about-p' data-i18n='sobre-metodo-2'>Após essa etapa, os dados passam por limpeza, "
        "normalização e validação de qualidade, com correções contínuas sempre que novas "
        "inconsistências, lacunas ou oportunidades de melhoria são identificadas.</p>\n"
        "<hr class='divider'>\n"
